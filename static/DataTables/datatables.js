 ...
 *   https://datatables.net/download/#bs5/dt-1.13.3/r-2.4.0/sb-1.4.0
 *
 * Included libraries:
 *   DataTables 1.13.3, Responsive 2.4.0, SearchBuilder 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.3/r-2.4.0/sb-1.4.0",
